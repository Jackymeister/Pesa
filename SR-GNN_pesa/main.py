...
parser.add_argument('--dataset', default='30music', help='dataset name: diginetica/yoochoose1_4/yoochoose1_64/sample')
...
parser.add_argument('--use_SEQL', action='store_false', help='use SEQL loss')
parser.add_argument('--include_common', action='store_true', help='use common category')
...
parser.add_argument('--ignore_prob', type=float, default=0.8, help='probability threshold to ignore weight for SEQL')
...
def main():
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 310  # include padding item, should be 309
